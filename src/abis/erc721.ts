export const ERC721_ABI = [
  ...
  },
  {
    ...
    inputs: [
      {
        components: [
          { internalType: "uint128", name: "startTokenId", type: "uint128" },
          { internalType: "uint128", name: "endTokenId", type: "uint128" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "address", name: "_elementDrop", type: "address" },
      { internalType: "address", name: "_transferValidator", type: "address" },
      { internalType: "address", name: "_protocolRecipient", type: "address" },
      { internalType: "uint16", name: "_protocolPoint", type: "uint16" },
    ],
    name: "initialize",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint64", name: "refundEndTime", type: "uint64" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [
      { internalType: "bytes32", name: "newProvenanceHash", type: "bytes32" },
    ],
  ...
  {
    inputs: [
      { internalType: "uint32", name: "newRefundPeriod", type: "uint32" },
    ],
